...
checklist = {'1a' : {'lab' : 'Since last visit: #1 "Patient used illicit drugs or evidences problem drinking" #1a Illicit drugs',
                     ...
                     'negation' : True,
                     'preview' : False},
             '1b' : {'lab' : '#1b Problematic alcohol use',
             ...
             '1c' : {'lab' : '1c. DUIs',
                     ...
                     'negation' : True,
                     'preview' : False},
             '2' : {'lab' : '#2 "Patient has hoarded meds"',
                     ...
                     'preview' : False,
                     'common_fp' : ['hoarder']},
              '3' : {'lab' : '#3 "Patient used more narcotic than prescribed"',
                     'pat' : r'((more+(?=.{1,50}than presc))|(ta?o?o?ke?i?n?g? extra(?![^\.]{1,10}strength)))',
                     'col_name' : 'more_narcotic',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
              '4' : {'lab' : '#4 "Patient ran out of meds early"',
              ...
              '5a' : {'lab' : '#5a "Patient has increased use of narcotics" 5a. Increased narcotic/opioid use',
                     'pat' : r'((increased|increasing) use)',
                     'col_name' : 'increased_op',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
              '5b' : {'lab' : '#5b Dose escalation (alternative to increased use)',
                     'pat' : r'((escalate?d?i?o?n?(?=((.{1,10})dos)))|(dose?a?g?e?(?=((.{1,10})escalat))))',
                     'col_name' : 'escalation_op',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
              '6' : {'lab' : '#6 "Patient used analgesics PRN when prescription is for time contingent use"',
             ...
             '7a' : {'lab' : '#7 "Patient received narcotics from more than one provider"',
                     ...
                     'preview' : False,
                     'common_fp' : ['diagnoses']},
             '7b' : {'lab' : 'Alternate "More than one provider" Search',
                     'pat' : r'(more than one|multiple)(?=((.{1,50}(provider|doctor|pharmac|prescrib))))',
                     ...
                     'preview' : False,
                     'common_fp' : ['diagnoses']},
             '8' : {'lab' : '#8 "Patient bought meds on the streets"',  #alternate: r'((med|drug).{1,10}(on the street))|((on the street).{1,10}(med|drug))'
                     'pat' : r'(on the street)', 
                     'col_name' : 'bought_on_street',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
             '9' : {'lab' : '#9 "Patient appears sedated or confused (e.g., slurred speech, unresponsive)"',
                     'pat' : r'(sedated|confused|(slurred speech)|unresponsive)',
                     'col_name' : 'sedated',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
             '10' : {'lab' : '#10 "Patient expresses worries about addiction"',
                     'pat' : r'(worr.{1,25}addic)',
                     'col_name' : 'worries_about_addiction',
                     'opioid' : False,
                     'negation' : True,
                     'preview' : False},
             '11a' : {'lab' : '#11 "Patient expressed a strong preference for a specific type of analgesic or a specific route of administration"',
                     ...
                     'preview' : False,
                     'common_fp' : ['pharm']},
             '11b' : {'lab' : '#11b Strong Preference, IV',
                     'pat' : 'r((patient|pt) (request|prefer|(prefers to take))([^\.]{1,10}IV))',
                     'col_name' : 'strong_preference_IV',
                     'opioid' : False,
                     'negation' : False,
                     'preview' : False},
             '12a' : {'lab' : '#12a "Patient expresses concern about future availability of narcotic"', #change take to tak and add opioid detection
             ...
             '12b' : {'lab' : '#12b Future Availability: Loss of medication',
                     'pat' : r'((((won|can)\'?t)[^\.]{1,25}(get))|(loss of medication))',
                     'col_name' : 'future_availability_2',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False},
             '13' : {'lab' : '#13 "Patient reports worsened relationships with family"',
                     ...
                     'negation' : True,
                     'preview' : False},
             '14' : {'lab' : '#14 "Patient misrepresented analgesic prescription or use"', 
                     'pat' : r'(misrepresent|(lied? about)|(\blying about))',
                     'col_name' : 'misrep_use',
                     'opioid' : True,
                     'negation' : False,
                     'preview' : False},
             '15' : {'lab' : '#15 "Patient indicated she or he ‘‘needs’’ or ‘‘must have’’ analgesic meds"',
                     ...
                     'preview' : False,
                     'common_fp' : [r'[0-9]']},
             '16' : {'lab' : '#16 "Discussion of analgesic meds was the predominant issue of visit"',
             ...
             '17' : {'lab' : '#17 "Patient exhibited lack of interest in rehab or self-management"',
                     ...
                     'negation' : False,
                     'preview' : False},
             '18a' : {'lab' : '#18a "Patient reports minimal/inadequate relief from narcotic analgesic"',
                     'pat' : r'(not?\b|minimal|limited)([^\.]{1,25})(relief (from|with|w/t|))',
                     'col_name' : 'minimal_relief_x',
                     'opioid' : True,
                     'negation' : False,
                     'preview' : False},
             '18b' : {'lab' : 'Patient reports minimal/inadequate relief: Tolerance',
                     'pat' : r'(\btoleran)',
                     'col_name' : 'tolerance',
                     'opioid' : True,
                     'negation' : True,
                     'preview' : False,
                     'common_fp' : ['activity']},
             '19' : {'lab' : '#19 "Patient indicated difficulty with using medication agreement"',
                     ...
                     'negation' : False,
                     'preview' : False},
             '20' : {'lab' : '#20 (Other) "Significant others express concern over patient’s use of analgesics"',
