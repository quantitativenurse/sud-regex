"""
This file contains a dictionary of the ABC pattern library with each item's label,
...
pattern_library = {
    ...
    "1b": {
        ...
        "col_name": "problematic_alcohol_use",
        "opioid": False,
        "negation": True,
        "preview": False,
    ...
    "4": {
        ...
        "col_name": "ran_out_of_meds_early",
        "opioid": True,
        "negation": True,
        "preview": False,
    ...
    "7a": {
        ...
        "col_name": "multiple_providers_primary",
        "opioid": True,
        "negation": True,
        "preview": False,
        "common_fp": ["diagnoses"],
    ...
    "7b": {
        ...
        "pat": r"(more than one|multiple)(?=((.{1,50}(provider|doctor|pharmac|prescrib))))",
        "col_name": "multiple_providers_alt",
        "opioid": True,
        "negation": True,
        "preview": False,
        "common_fp": ["diagnoses"],
    ...
    "8": {
        ...
        "pat": r"(on the street)",
        "col_name": "bought_meds_on_street",
        "opioid": True,
        "negation": True,
        "preview": False,
    },
    ...
    "11a": {
        ...
        "col_name": "strong_med_preference",
        "opioid": True,
        "negation": True,
        "preview": False,
        "common_fp": ["pharm"],
    ...
    "11b": {
        ...
        "col_name": "strong_med_preference_iv",
        "opioid": False,
        "negation": False,
        "preview": False,
        "common_fp": ["HIV testing"],
    },
    "12a": {
        ...
        "col_name": "future_availability_taken_away",
        "opioid": True,
        "negation": True,
        "preview": False,
    ...
    "12b": {
        ...
        "col_name": "future_availability_med_loss",
        "opioid": True,
        "negation": True,
        "preview": False,
    },
    "13": {
        ...
        "col_name": "worsened_family_relationships",
        "opioid": True,
        "negation": True,
        "preview": False,
    },
    ...
    "17": {
        ...
        "col_name": "lack_interest_in_rehab",
        "opioid": True,
        "negation": False,
        "preview": False,
    },
    "18a": {
        ...
        "col_name": "minimal_relief",
        "opioid": True,
        "negation": False,
        "preview": False,
        "common_fp": ["if no relief"],
    },
    "18b": {
        "lab": "Patient reports minimal/inadequate relief: Tolerance",
        "pat": r"(\btoleran)",
        "col_name": "opioid_tolerance",
        "opioid": True,
        "negation": True,
        "preview": False,
        "common_fp": ["activity"],
    ...
    "19": {
        ...
        "col_name": "med_agreement_difficulty",
        "opioid": False,
        "negation": False,
        "preview": False,
    },
    "20": {
        ...
        "col_name": "significant_other_concern",
        "opioid": True,
        "negation": True,
        "preview": False,
    },
